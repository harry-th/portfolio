    ...
    content: [
        ...
        },
        {
            ...
            value: ["This is a multiplayer battleship game, though because battleship is boring I added additional rules, the rules are however somewhat too complicated to explain succinctly.",
                ...
                "Lineman has 4 charges for his abilities, he can fire two shots with one at the last two squares the opponent shot at or can connect any two squares and shot at every square between as long as you or your enemy hasn't shot at anything in between.",
                "Orangeman has a passive ability which protects squares he has shot at (they can't fire at them for one turn), or he can 'bluff', when bluffing he can't see wether his shots land but for each shot he gains a charge on a subsequent ability which will fire randomly at the opponent boards three times for each bluff.",
